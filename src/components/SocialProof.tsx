  ...
  return (
    <section ref={sectionRef} className="pt-8 pb-20 md:pt-16 md:pb-24 px-6">
      <div className="max-w-[1200px] mx-auto">
        ...
        <p className="reveal reveal-delay-1 font-display text-xl md:text-2xl lg:text-3xl text-foreground leading-snug mb-16 max-w-[800px]">
        ...
        {/* Qualitative pillars */}
        <div className="reveal reveal-delay-2 flex flex-wrap items-center justify-start gap-8 md:gap-16">
